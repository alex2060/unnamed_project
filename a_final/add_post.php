  ...
  <div class="container ">
    ...
    <div class=" d-flex justify-content-center">
      <form action="" class="mt-3">
        ...
        <div class="form-group">
              <label for="uname" class="text-white">Photo</label>
              <input type="text" class="form-control" id="hash" name="photo" placeholder="Photo" value="">
        </div>

        <div class="form-group">
              <label for="uname" class="text-white">IFrame</label>
        ...
        <div class="form-group">
              ...
              <input type="text" class="form-control" id="hash" name="catagoy" placeholder="catagoy" value="">
        </div>


        <div class="form-group">
              <label for="uname" class="text-white">catagoy 2</label>
              <input type="text" class="form-control" id="hash" name="catagoy_2" placeholder="catagoy 2" value="">
        </div>
