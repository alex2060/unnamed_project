...
$template = str_replace('\'' ,  '(!B???!???A!)' , $template);
...
<label for="uname" class="text-white">template dev</label>
  
      </br>
<label for="uname" class="text-white">(!A???!???A!)->" </label>

      </br>
<label for="uname" class="text-white">(!B???!???B!)->' </label>


      </br>
<label for="uname" class="text-white">(!C???!???C!)->' </label>

      </br>
<label for="uname" class="text-white">(!D???!???D!)->D </label>
        </br>
<label for="uname" class="text-white">(!0???!???0!)->var1 </label>
  </br>
<label for="uname" class="text-white">(!U???!???U!)->uname </label>
    </br>
<label for="uname" class="text-white">(!S???!???S!)->setion </label>
