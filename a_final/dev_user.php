...
<label for="uname" class="text-white">add user </label>
</br>
<label for="uname" class="text-white">http://alexhaussmann.com/adhaussmann/a_final/add_user_dev.php?uname=gogogo22&hashword=wegonow2&email=alex.haussmann%40gmail.com</label>
