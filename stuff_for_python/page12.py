...
myurl="http://alexhaussmann.com/adhaussmann/a_final/change_post.php?uname=MyUserForTest"+randomval+"&hashword=password&change_text=newtext&post="+postkey
...
myurl="http://alexhaussmann.com/adhaussmann/a_final/change_post.php?uname=\nMyUserForTest"+randomval+"&hashword=password\n&change_text=newtext&post="+postkey
