...
myurl="http://alexhaussmann.com/adhaussmann/a_final/add_key_dev.php?uname=MyUserForTest\n"+randomval+"&password=password&email="+email
...
Label(
    ws,
    text="next we make a key with this url  \n"+myurl,
    padx=20,
    pady=20,
    bg='#5d8a82',
    font=f
